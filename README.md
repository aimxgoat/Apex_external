Hi guy , as the title indicates I am selling my old external apex , update , all without kernel driver ! , no mouse_event for aimbot ( using safe method that you cant use into any game )
